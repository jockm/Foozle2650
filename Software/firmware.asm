...
; firmware for a Signetics 2650 single board computer
;
; Based on the firmware.asm file found in:
;	https://github.com/jim11662418/Signetics-2650-SBC
; 
; Memory map is slightly compatible, but slighly different.  License is
; unknown.  PIPBUG was shared freely by Signetics, Microworld Basic is
; being treated as abandonware.
; 
; This file is intended to be built with VACS for the 2650:
...
;   6000-7BFF   Additional RAM
;   7C00-7C0F   IO Expansion 1
;   7D00-7D0F   IO Expansion 2
